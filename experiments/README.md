...
| [`phone-photo-augmentation/`](phone-photo-augmentation/README.md) | Do simulated phone-camera artifacts (JPEG / blur / noise) as training augmentation improve the synth-only recognizer? (No — a clean negative result.) |
